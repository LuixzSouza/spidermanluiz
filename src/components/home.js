...
export function HomeSection() {
    return(
        <ContainerGrid className={"py-32 bg-bgHero bg-cover bg-no-repeat bg-center"} >
            <div className="flex flex-col items-center justify-center text-center @desktop:text-left @desktop:justify-start @desktop:items-start" >
                ...
                <p className="w-full max-w-[642px] font-robotoflex text-lg text-white mb-12" >Os Spiders Peter Parker e Miles Morales estão de volta em mais uma aventura eletrizante da famosa franquia Marvel&apos;s Spider-Man para PS5.</p>
                ...
                <div className="flex flex-col items-center mt-20 gap-4 @desktop:items-start" >
